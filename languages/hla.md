## High Level Assembly (HLA) — histoire

- 2000 : conçu ou formalisé (Randall Hyde) pour répondre aux besoins de son domaine d'application.
...
## High Level Assembly (HLA) — utilité

- Assembleur x86 intégrant des structures de contrôle de haut niveau.
...
## High Level Assembly (HLA) — ressources

- Site officiel : [https://www.plantation-productions.com/Webster/](https://www.plantation-productions.com/Webster/)
