## Intel Cilk Plus — histoire

- 2010 : conçu ou formalisé (Intel Corporation) pour répondre aux besoins de son domaine d'application.
...
## Intel Cilk Plus — utilité

- Extension de C/C++ pour le parallélisme vectoriel et multi-cœur.
...
## Intel Cilk Plus — ressources

- Site officiel : [https://en.wikipedia.org/wiki/Cilk_Plus](https://en.wikipedia.org/wiki/Cilk_Plus)
