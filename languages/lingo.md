## Lingo (Macromedia Director) — histoire

- 1988 : conçu ou formalisé (John Thompson) pour répondre aux besoins de son domaine d'application.
...
## Lingo (Macromedia Director) — utilité

- Scripting interactif multimédia pour CD-ROMs et animations Director.
...
## Lingo (Macromedia Director) — ressources

- Site officiel : [https://en.wikipedia.org/wiki/Lingo_(programming_language)](https://en.wikipedia.org/wiki/Lingo_(programming_language))
