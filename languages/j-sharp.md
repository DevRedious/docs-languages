...
- Transition et portage des applications Java vers le framework .NET.
...
- Site officiel : [https://en.wikipedia.org/wiki/Visual_J_Sharp](https://en.wikipedia.org/wiki/Visual_J_Sharp)
