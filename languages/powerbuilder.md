## PowerScript (PowerBuilder) — histoire

- 1991 : conçu ou formalisé (Powersoft / SAP / Appeon) pour répondre aux besoins de son domaine d'application.
...
## PowerScript (PowerBuilder) — utilité

- Développement visuel rapide d'applications d'entreprise clientes-serveur SQL (DataWindow).
...
## PowerScript (PowerBuilder) — ressources

- Site officiel : [https://www.appeon.com/products/powerbuilder](https://www.appeon.com/products/powerbuilder)
