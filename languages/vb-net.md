## Visual Basic .NET — histoire

- 2002 : conçu ou formalisé (Microsoft) pour répondre aux besoins de son domaine d'application.
...
## Visual Basic .NET — utilité

- Modernisation orientée objet de Visual Basic sur le runtime .NET.
...
## Visual Basic .NET — ressources

- Site officiel : [https://learn.microsoft.com/dotnet/visual-basic/](https://learn.microsoft.com/dotnet/visual-basic/)
