## Kaleidoscope — histoire

- 1990 : conçu ou formalisé (Univ Washington) pour répondre aux besoins de son domaine d'application.
...
## Kaleidoscope — utilité

- Contraintes déclaratives impératives et interfaces graphiques.
...
## Kaleidoscope — ressources

- Site officiel : [https://en.wikipedia.org/wiki/Kaleidoscope_(programming_language)](https://en.wikipedia.org/wiki/Kaleidoscope_(programming_language))
