## APT (Automatically Programmed Tool) — histoire

- 1956 : conçu ou formalisé (Douglas T. Ross (MIT)) pour répondre aux besoins de son domaine d'application.
...
## APT (Automatically Programmed Tool) — utilité

- Tout premier langage de programmation de machines-outils à commande numérique (CNC).
...
## APT (Automatically Programmed Tool) — ressources

- Site officiel : [https://en.wikipedia.org/wiki/APT_(programming_language)](https://en.wikipedia.org/wiki/APT_(programming_language))
