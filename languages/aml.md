## AML (A Manufacturing Language) — histoire

- 1982 : conçu ou formalisé (IBM) pour répondre aux besoins de son domaine d'application.
...
## AML (A Manufacturing Language) — utilité

- Programmation robotique industrielle pour lignes d'assemblage.
...
## AML (A Manufacturing Language) — ressources

- Site officiel : [https://en.wikipedia.org/wiki/AML_(programming_language)](https://en.wikipedia.org/wiki/AML_(programming_language))
