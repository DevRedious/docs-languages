## Bywater BASIC (bwBASIC) — histoire

- 1993 : conçu ou formalisé (Ted A. Campbell) pour répondre aux besoins de son domaine d'application.
...
## Bywater BASIC (bwBASIC) — utilité

- Interpréteur BASIC open source ANSI/POSIX ultra-portable en C.
...
## Bywater BASIC (bwBASIC) — ressources

- Site officiel : [https://sourceforge.net/projects/bwbasic/](https://sourceforge.net/projects/bwbasic/)
