## C/AL (Dynamics NAV) — histoire

- 1990 : conçu ou formalisé (Navision / Microsoft) pour répondre aux besoins de son domaine d'application.
...
## C/AL (Dynamics NAV) — utilité

- Langage de logique comptable et ERP de Microsoft Dynamics NAV.
...
## C/AL (Dynamics NAV) — ressources

- Site officiel : [https://learn.microsoft.com/dynamics-nav-app/](https://learn.microsoft.com/dynamics-nav-app/)
