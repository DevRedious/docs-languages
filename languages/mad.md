## MAD (Michigan Algorithm Decoder) — histoire

- 1959 : conçu ou formalisé (Université du Michigan) pour répondre aux besoins de son domaine d'application.
...
## MAD (Michigan Algorithm Decoder) — utilité

- Compilateur ultra-rapide sur ordinateurs centraux IBM 704/7090.
...
## MAD (Michigan Algorithm Decoder) — ressources

- Site officiel : [https://en.wikipedia.org/wiki/Michigan_Algorithm_Decoder](https://en.wikipedia.org/wiki/Michigan_Algorithm_Decoder)
