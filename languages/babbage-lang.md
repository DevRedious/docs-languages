## Babbage Language — histoire

- 1971 : conçu ou formalisé (GEC Computers) pour répondre aux besoins de son domaine d'application.
...
## Babbage Language — utilité

- Langage d'assemblage de haut niveau pour les mini-ordinateurs GEC 4000.
...
## Babbage Language — ressources

- Site officiel : [https://en.wikipedia.org/wiki/Babbage_(programming_language)](https://en.wikipedia.org/wiki/Babbage_(programming_language))
