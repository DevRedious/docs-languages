## ColdFusion (CFML) — histoire

- 1995 : conçu ou formalisé (Allaire / Adobe) pour répondre aux besoins de son domaine d'application.
...
## ColdFusion (CFML) — utilité

- Scripting web balisé d'entreprise sur JVM.
...
## ColdFusion (CFML) — ressources

- Site officiel : [https://www.adobe.com/products/coldfusion-family.html](https://www.adobe.com/products/coldfusion-family.html)
