## SLIP (Symmetric List Processor) — histoire

- 1963 : conçu ou formalisé (Joseph Weizenbaum (MIT)) pour répondre aux besoins de son domaine d'application.
...
## SLIP (Symmetric List Processor) — utilité

- Traitement de listes symétriques ayant servi à programmer le premier chatbot ELIZA.
...
## SLIP (Symmetric List Processor) — ressources

- Site officiel : [https://en.wikipedia.org/wiki/SLIP_(programming_language)](https://en.wikipedia.org/wiki/SLIP_(programming_language))
