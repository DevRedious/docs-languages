## Caché ObjectScript — histoire

- 1997 : conçu ou formalisé (InterSystems) pour répondre aux besoins de son domaine d'application.
...
## Caché ObjectScript — utilité

- Base multidimensionnelle et transactions médicales.
...
## Caché ObjectScript — ressources

- Site officiel : [https://docs.intersystems.com](https://docs.intersystems.com)
