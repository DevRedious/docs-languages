## Transact-SQL (T-SQL) — histoire

- 1989 : conçu ou formalisé (Microsoft / Sybase) pour répondre aux besoins de son domaine d'application.
...
## Transact-SQL (T-SQL) — utilité

- Extension procédurale du SQL pour Microsoft SQL Server.
...
## Transact-SQL (T-SQL) — ressources

- Site officiel : [https://learn.microsoft.com/sql/t-sql/](https://learn.microsoft.com/sql/t-sql/)
