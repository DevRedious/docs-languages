## CASL Basic Spec — histoire

- 2004 : conçu ou formalisé (BIFROST / CoFI) pour répondre aux besoins de son domaine d'application.
...
## CASL Basic Spec — utilité

- Spécification algébrique de structures mathématiques abstraites.
...
## CASL Basic Spec — ressources

- Site officiel : [https://www.informatik.uni-bremen.de/cofi/](https://www.informatik.uni-bremen.de/cofi/)
