## Object Oberon — histoire

- 1989 : conçu ou formalisé (ETH Zurich / H. Mössenböck) pour répondre aux besoins de son domaine d'application.
...
## Object Oberon — utilité

- Extension orientée objet de base pour le langage Oberon.
...
## Object Oberon — ressources

- Site officiel : [https://en.wikipedia.org/wiki/Oberon_(programming_language)](https://en.wikipedia.org/wiki/Oberon_(programming_language))
