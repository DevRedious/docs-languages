## QuickBASIC (QBasic) — histoire

- 1985 : conçu ou formalisé (Microsoft) pour répondre aux besoins de son domaine d'application.
...
## QuickBASIC (QBasic) — utilité

- Compilateur et environnement BASIC interactif dominant sous MS-DOS.
...
## QuickBASIC (QBasic) — ressources

- Site officiel : [https://en.wikipedia.org/wiki/QuickBASIC](https://en.wikipedia.org/wiki/QuickBASIC)
