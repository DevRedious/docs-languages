## Spin (Propeller) — histoire

- 2006 : conçu ou formalisé (Parallax Inc.) pour répondre aux besoins de son domaine d'application.
...
## Spin (Propeller) — utilité

- Programmation du microcontrôleur multicœur Parallax Propeller.
...
## Spin (Propeller) — ressources

- Site officiel : [https://www.parallax.com/propeller-1/](https://www.parallax.com/propeller-1/)
