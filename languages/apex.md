...
- 2006 : conçu ou formalisé (Salesforce) pour répondre aux besoins de son domaine d'application.
...
- Langage objet cloud native pour la plateforme CRM Salesforce.
...
- Site officiel : [https://developer.salesforce.com/docs/atlas.en-us.apexcode.meta/apexcode/](https://developer.salesforce.com/docs/atlas.en-us.apexcode.meta/apexcode/)
