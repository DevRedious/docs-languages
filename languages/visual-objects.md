## Visual Objects — histoire

- 1995 : conçu ou formalisé (Computer Associates) pour répondre aux besoins de son domaine d'application.
...
## Visual Objects — utilité

- Développement orienté objet sous Windows pour applications xBase.
...
## Visual Objects — ressources

- Site officiel : [https://en.wikipedia.org/wiki/CA-Visual_Objects](https://en.wikipedia.org/wiki/CA-Visual_Objects)
