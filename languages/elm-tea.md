## The Elm Architecture — histoire

- 2016 : conçu ou formalisé (Evan Czaplicki) pour répondre aux besoins de son domaine d'application.
...
## The Elm Architecture — utilité

- Modèle d'état réactif unidirectionnel ayant directement inspiré Redux.
...
## The Elm Architecture — ressources

- Site officiel : [https://guide.elm-lang.org/architecture/](https://guide.elm-lang.org/architecture/)
