## VBA (Visual Basic for Apps) — histoire

- 1993 : conçu ou formalisé (Microsoft) pour répondre aux besoins de son domaine d'application.
...
## VBA (Visual Basic for Apps) — utilité

- Automatisation de feuilles de calcul Excel et documents Office.
...
## VBA (Visual Basic for Apps) — ressources

- Site officiel : [https://learn.microsoft.com/office/vba/api/overview/](https://learn.microsoft.com/office/vba/api/overview/)
