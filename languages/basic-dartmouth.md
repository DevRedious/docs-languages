## Dartmouth BASIC — histoire

- 1964 : conçu ou formalisé (John Kemeny, Thomas Kurtz) pour répondre aux besoins de son domaine d'application.
...
## Dartmouth BASIC — utilité

- Le BASIC originel qui a ouvert l'informatique grand public.
...
## Dartmouth BASIC — ressources

- Site officiel : [https://en.wikipedia.org/wiki/Dartmouth_BASIC](https://en.wikipedia.org/wiki/Dartmouth_BASIC)
