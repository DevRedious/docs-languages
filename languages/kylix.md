## Borland Kylix — histoire

- 2001 : conçu ou formalisé (Borland) pour répondre aux besoins de son domaine d'application.
...
## Borland Kylix — utilité

- Portage natif de Delphi et C++Builder sous Linux avec la bibliothèque CLX.
...
## Borland Kylix — ressources

- Site officiel : [https://en.wikipedia.org/wiki/Borland_Kylix](https://en.wikipedia.org/wiki/Borland_Kylix)
