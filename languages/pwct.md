## PWCT (Programming Without Coding) — histoire

- 2006 : conçu ou formalisé (Mahmoud Fayed) pour répondre aux besoins de son domaine d'application.
...
## PWCT (Programming Without Coding) — utilité

- Programmation visuelle générale générant du code source complet.
...
## PWCT (Programming Without Coding) — ressources

- Site officiel : [http://pwct.org](http://pwct.org)
